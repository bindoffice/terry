...
bitflags! {
    ...
    pub struct Flags: u16 {
        ...
        const IMAGE                     = 0b1000_0000_0000_0000;
...
pub struct CellExtra {
    ...
    /// Image placement id this cell is the top-left of.
    #[serde(default)]
    image: Option<u32>,
}
...
impl Cell {
    ...
    /// Set the image placement id of this cell.
    pub fn set_image(&mut self, image: Option<u32>) {
    ...
    /// Image placement id stored in this cell, if any.
    #[inline]
    pub fn image(&self) -> Option<u32> {
        self.extra.as_ref()?.image
    }
}
...
impl GridCell for Cell {
    ...
    fn is_empty(&self) -> bool {
        (self.c == ' ' || self.c == '\t')
            ...
            && self.extra.as_ref().map(|extra| extra.image.is_none()) != Some(false)
    }
