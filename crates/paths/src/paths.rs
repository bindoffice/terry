...
/// On macOS, this is `~/Library/Application Support/Terry`.
/// On Linux/FreeBSD, this is `$XDG_DATA_HOME/terry`.
/// On Windows, this is `%LOCALAPPDATA%\Terry`.
static CURRENT_DATA_DIR: OnceLock<PathBuf> = OnceLock::new();

/// The resolved config directory, combining custom override or platform defaults.
/// This is set once and cached for subsequent calls.
/// On macOS, this is `~/.config/terry`.
/// On Linux/FreeBSD, this is `$XDG_CONFIG_HOME/terry`.
/// On Windows, this is `%APPDATA%\Terry`.
